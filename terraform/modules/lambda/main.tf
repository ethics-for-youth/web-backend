...
locals {
  ...
  # e.g., "efy-web-backend-dev-events-get" -> "events_get"
  # Match everything after "-(dev|qa|prod)-" and convert dashes to underscores
  function_without_prefix = regex("-(dev|qa|prod)-(.*)", var.function_name)[1]
